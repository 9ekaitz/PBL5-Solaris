...
public class ShopControllerTest {
    ...
    void loadUser() {
        ...
        List<Address> addresses = Stream
                .of(new Address(1L, new Country(1L, null, "uwu", 1), new Province(1L, null, "UWU", null, null, 1), "Vitoria", "01008", "Pintor Clemente Arraiz",
    ...
    void getShopIndexTest() throws Exception {
        List<Product> products = Stream.of(new Product(1L, 200D, null, null, null, 1), new Product(2L, 300D, null, null, null, 1), new Product(3L, 400D, null, null, null, 1))
                .collect(Collectors.toList());
    ...
    void getCheckoutTest() throws Exception{
        List<CartProduct> cartProducts = Stream
                .of(new CartProduct(1L, new Product(1L, 200D, null, null, null, 1), 2, basicUser, 1), new CartProduct(2L, new Product(2L, 150D, null, null, null, 1), 1, basicUser, 1)).collect(Collectors.toList());
